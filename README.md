...
The raw dataset contained 609 records with a severe class imbalance (approx. 88% to 12% ratio). To prevent the model from favoring the majority class, dynamic class weighting (`class_weight='balanced'`) was implemented across all algorithms.
...
* **Heatmaps:** Illustrating feature variations between classes.
* **Volcano Plots:** Visualizing the statistical significance and magnitude of feature changes.
* **Confusion Matrices:** Providing a transparent breakdown of model predictions.
